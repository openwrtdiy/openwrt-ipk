...
qosdef_flush_dynamic() {
	qosdef_flush_table "$NFT_QOS_INET_FAMILY" nft-qos-unofficial-dynamic
}
...
qosdef_init_dynamic() {
	...
	[ "$2" = 0 ] || {
		logger -t nft-qos-unofficial-dynamic "validation failed"
		return 1
	}
	...
	qosdef_appendx "table $NFT_QOS_INET_FAMILY nft-qos-unofficial-dynamic {\n"
