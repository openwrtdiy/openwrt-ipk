...
qosdef_flush_static() {
	qosdef_flush_table "$NFT_QOS_INET_FAMILY" nft-qos-unofficial-static
}
...
qosdef_init_static() {
	...
	[ "$2" = 0 ] || {
		logger -t nft-qos-unofficial-static "validation failed"
		return 1
	}
	...
	qosdef_appendx "table $NFT_QOS_INET_FAMILY nft-qos-unofficial-static {\n"
