...
-- Static
--
o = s:taboption("limit", Flag, "limit_ip_enable", translate("Enable IP address speed limit"), translate("Enable Limit Rate Feature"))
...
if limit_ip_enable == "1" and limit_type == "static" then
	...
	x = m:section(TypedSection, "user", translate("Static QoS-Download Rate"))
	x.anonymous = true
	x.addremove = true
